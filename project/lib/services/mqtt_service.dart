...
class DashboardData {
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    return DashboardData(
      ...
      PV2_Active_Power_kW: (json['PV2_Active_Power_kW'] ?? 0).toDouble(),
      ...
      PV3_Active_Power_kW: (json['PV3_Active_Power_kW'] ?? 0).toDouble(),
      ...
      PV4_Active_Power_kW: (json['PV4_Active_Power_kW'] ?? 0).toDouble(),
